...
function Posts() {
  // 2. สร้าง state
  const [postList, setPostList] = useState(innitialPostList);

  const handleLikeButtonClick = (postIndex) => {
  ...
  const handleDislikeButtonClick = (postIndex) => {
  ...
  return (
    <div class="app-wrapper">
      ...
      <div class="post-list">
        {/* 3. นำ postList มา render เป็น item ด้วย Array.map*/}
